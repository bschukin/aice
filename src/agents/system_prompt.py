...
class SystemPrompt:
    ...
    def get_agent_prompt(self)->str:
        ...
        prompt, self._used_prompt = self.load_prompt(self._project, self._agent)

        # загружаем  промпт команды
        team_prompt, t  = self.load_prompt(self._project, "team", False)
    ...
    @staticmethod
    def load_prompt(project, prompt_name, use_default_prompt=True)->[str,str]:
